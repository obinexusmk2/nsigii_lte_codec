 ...
 * ─── ELASTIC BAND MODEL ──────────────────────────────────────────────────────
 *
 *   CREATE = band relaxed and stable
 *   DESTROY = band released (no tension)
 *   RENEW   = band stretched (energy stored, computation in progress)
 *   Amplitude ↑ = pull harder (resist noise)
 *   Frequency shift = change rhythm (move away from interference)
 *
 * ─────────────────────────────────────────────────────────────────────────────
 */
